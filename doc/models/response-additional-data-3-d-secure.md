...
|  --- | --- | --- | --- |
| `card_holder_info` | `String` | Optional | Information provided by the issuer to the cardholder. If this field is present, you need to display this information to the cardholder. |
...
| `cavv_algorithm` | `String` | Optional | The CAVV algorithm used. |
...
| `threeds_2_card_enrolled` | `TrueClass \| FalseClass` | Optional | Indicates whether a card is enrolled for 3D Secure 2. |
