...
| `addr_match` | [`AddrMatch1`](../../doc/models/addr-match-1.md) | Optional | Indicates whether the cardholder shipping Address and cardholder billing address are the same. Allowed values:<br><br>* **Y** — Shipping Address matches Billing Address.<br>* **N** — Shipping Address does not match Billing Address.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `1` |
...
| `sdk_app_id` | `String` | Optional | The `sdkAppID` value as received from the 3D Secure 2 SDK. |
| `sdk_ephem_pub_key` | [`SdkEphemPubKey1`](../../doc/models/sdk-ephem-pub-key-1.md) | Optional | The `sdkEphemPubKey` value as received from the 3D Secure 2 SDK. |
...
| `sdk_reference_number` | `String` | Optional | The `sdkReferenceNumber` value as received from the 3D Secure 2 SDK. |
| `sdk_trans_id` | `String` | Optional | The `sdkTransID` value as received from the 3D Secure 2 SDK. |
