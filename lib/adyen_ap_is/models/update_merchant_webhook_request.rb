...
module AdyenApIs
  # UpdateMerchantWebhookRequest Model.
  class UpdateMerchantWebhookRequest < BaseModel
    ...
    def initialize(accepts_expired_certificate: SKIP,
                   ...
                   network_type: SKIP, password: SKIP,
                   populate_soap_action_header: SKIP, url: SKIP, username: SKIP)
    ...
    def self.from_hash(hash)
      ...
      UpdateMerchantWebhookRequest.new(accepts_expired_certificate: accepts_expired_certificate,
    ...
    def to_s
      ...
      " populate_soap_action_header: #{@populate_soap_action_header}, url: #{@url}, username:"\
      " #{@username}>"
    end
    ...
    def inspect
      ...
      " populate_soap_action_header: #{@populate_soap_action_header.inspect}, url:"\
