...
module AdyenApIs
  ...
  # payment account, or new user(s) added.  Allowed values: * **01** — Changed
  # during this transaction * **02** — Less than 30 days * **03** — 30–60 days *
  ...
  class ChAccChangeInd
    ...
    def self.validate(value)
      ...
      CH_ACC_CHANGE_IND.include?(value)
    end
