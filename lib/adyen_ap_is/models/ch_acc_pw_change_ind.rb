...
module AdyenApIs
  ...
  # Requestor had a password change or account reset.  Allowed values: * **01**
  # — No change * **02** — Changed during this transaction * **03** — Less than
  ...
  class ChAccPwChangeInd
    ...
    def self.validate(value)
      ...
      CH_ACC_PW_CHANGE_IND.include?(value)
    end
