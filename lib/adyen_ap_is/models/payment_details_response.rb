...
module AdyenApIs
  # PaymentDetailsResponse Model.
  class PaymentDetailsResponse < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # Action to be taken for completing the payment. When returned, only the 3D
    # Secure action is needed in most cases.
    ...
    def initialize(action: SKIP, additional_data: SKIP, amount: SKIP,
                   ...
                   result_code: SKIP, shopper_locale: SKIP,
                   three_ds2_response_data: SKIP, three_ds2_result: SKIP,
                   three_ds_payment_data: SKIP)
    ...
    def self.from_hash(hash)
      ...
      action = CheckoutThreeDs2Action.from_hash(hash['action']) if hash['action']
      additional_data =
      ...
      PaymentDetailsResponse.new(action: action,
    ...
    def to_s
      ...
      " #{@refusal_reason_code}, result_code: #{@result_code}, shopper_locale: #{@shopper_locale},"\
      " three_ds2_response_data: #{@three_ds2_response_data}, three_ds2_result:"\
      " #{@three_ds2_result}, three_ds_payment_data: #{@three_ds_payment_data}>"
    end
    ...
    def inspect
      ...
      " result_code: #{@result_code.inspect}, shopper_locale: #{@shopper_locale.inspect},"\
      " three_ds2_response_data: #{@three_ds2_response_data.inspect}, three_ds2_result:"\
      " #{@three_ds2_result.inspect}, three_ds_payment_data: #{@three_ds_payment_data.inspect}>"
    end
  end
end
