...
module AdyenApIs
  ...
  # (including previous fraud) on the cardholder account.  Allowed values: *
  # **01** — No suspicious activity has been observed * **02** — Suspicious
  ...
  class SuspiciousAccActivity
    ...
    def self.validate(value)
      ...
      SUSPICIOUS_ACC_ACTIVITY.include?(value)
    end
