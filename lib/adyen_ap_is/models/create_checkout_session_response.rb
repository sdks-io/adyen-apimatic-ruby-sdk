...
module AdyenApIs
  ...
  class CreateCheckoutSessionResponse < BaseModel
    ...
    # The URL for the Hosted Checkout page. Redirect the shopper to this URL so
    ...
    def self.names
      ...
      @_hash['session_data'] = 'sessionData'
    ...
    def initialize(amount:, expires_at:, id:, merchant_account:, reference:,
                   ...
                   session_data: SKIP, shopper_email: SKIP, shopper_ip: SKIP,
      ...
      @session_data = session_data unless session_data == SKIP
    ...
    def self.from_hash(hash)
      ...
      session_data = hash.key?('sessionData') ? hash['sessionData'] : SKIP
      ...
      CreateCheckoutSessionResponse.new(amount: amount,
                                        expires_at: expires_at,
                                        id: id,
                                        merchant_account: merchant_account,
                                        reference: reference,
    ...
    def to_s
      ...
      " #{@expires_at}, fund_origin: #{@fund_origin}, fund_recipient: #{@fund_recipient}, id:"\
      " #{@id}, installment_options: #{@installment_options}, line_items: #{@line_items}, mandate:"\
      ...
      " session_data: #{@session_data}, shopper_email: #{@shopper_email}, shopper_ip:"\
      " #{@shopper_ip}, shopper_interaction: #{@shopper_interaction}, shopper_locale:"\
      " #{@shopper_locale}, shopper_name: #{@shopper_name}, shopper_reference:"\
      " #{@shopper_reference}, shopper_statement: #{@shopper_statement}, show_installment_amount:"\
      " #{@show_installment_amount}, show_remove_payment_method_button:"\
      " #{@show_remove_payment_method_button}, social_security_number: #{@social_security_number},"\
      " split_card_funding_sources: #{@split_card_funding_sources}, splits: #{@splits}, store:"\
      " #{@store}, store_filtration_mode: #{@store_filtration_mode}, store_payment_method:"\
      ...
      " #{@three_ds_authentication_only}, trusted_shopper: #{@trusted_shopper}, url: #{@url}>"
    end
    ...
    def inspect
      ...
      " #{@fund_origin.inspect}, fund_recipient: #{@fund_recipient.inspect}, id: #{@id.inspect},"\
      " installment_options: #{@installment_options.inspect}, line_items: #{@line_items.inspect},"\
      " mandate: #{@mandate.inspect}, mcc: #{@mcc.inspect}, merchant_account:"\
      " #{@merchant_account.inspect}, merchant_order_reference:"\
      " #{@merchant_order_reference.inspect}, metadata: #{@metadata.inspect}, mode:"\
      " #{@mode.inspect}, mpi_data: #{@mpi_data.inspect}, platform_chargeback_logic:"\
      " #{@platform_chargeback_logic.inspect}, recurring_expiry: #{@recurring_expiry.inspect},"\
      " recurring_frequency: #{@recurring_frequency.inspect}, recurring_processing_model:"\
      ...
      " #{@return_url.inspect}, risk_data: #{@risk_data.inspect}, session_data:"\
      " #{@session_data.inspect}, shopper_email: #{@shopper_email.inspect}, shopper_ip:"\
