...
module AdyenApIs
  # CreateCompanyWebhookRequest Model.
  class CreateCompanyWebhookRequest < BaseModel
    ...
    # *  **includeAccounts** : The webhook is configured for the merchant
    ...
    def initialize(active:, communication_format:,
                   filter_merchant_account_type:, filter_merchant_accounts:,
                   type:, url:, accepts_expired_certificate: SKIP,
    ...
    def self.from_hash(hash)
      ...
      filter_merchant_account_type =
        hash.key?('filterMerchantAccountType') ? hash['filterMerchantAccountType'] : nil
      filter_merchant_accounts =
        hash.key?('filterMerchantAccounts') ? hash['filterMerchantAccounts'] : nil
      ...
      CreateCompanyWebhookRequest.new(active: active,
                                      communication_format: communication_format,
                                      filter_merchant_account_type: filter_merchant_account_type,
                                      filter_merchant_accounts: filter_merchant_accounts,
                                      type: type,
    ...
    def to_s
      ...
      " password: #{@password}, populate_soap_action_header: #{@populate_soap_action_header},"\
