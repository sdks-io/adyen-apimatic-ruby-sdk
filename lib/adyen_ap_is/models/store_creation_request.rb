...
module AdyenApIs
  ...
  class StoreCreationRequest < BaseModel
    ...
    def initialize(address:, description:, phone_number:, shopper_statement:,
                   business_line_ids: SKIP, external_reference_id: SKIP,
                   localized_information: SKIP, reference: SKIP,
                   split_configuration: SKIP, sub_merchant_data: SKIP)
      @address = address
    ...
    def self.from_hash(hash)
      ...
      StoreCreationRequest.new(address: address,
                               description: description,
                               phone_number: phone_number,
                               shopper_statement: shopper_statement,
    ...
    def to_s
      ...
      " localized_information: #{@localized_information}, phone_number: #{@phone_number},"\
      " reference: #{@reference}, shopper_statement: #{@shopper_statement}, split_configuration:"\
      " #{@split_configuration}, sub_merchant_data: #{@sub_merchant_data}>"
    end
    ...
    def inspect
      ...
      " #{@localized_information.inspect}, phone_number: #{@phone_number.inspect}, reference:"\
      " #{@reference.inspect}, shopper_statement: #{@shopper_statement.inspect},"\
      " split_configuration: #{@split_configuration.inspect}, sub_merchant_data:"\
      " #{@sub_merchant_data.inspect}>"
    end
  end
end
