  ...
  class PaymentResponse < BaseModel
    ...
    def self.from_hash(hash)
      ...
      action = hash.key?('action') ? APIHelper.deserialize_union_type(
        UnionTypeLookUp.get(:PaymentResponseAction), hash['action']
      ) : SKIP
      additional_data =
      ...
      PaymentResponse.new(action: action,
    ...
    # @param [PaymentResponse | Hash] The value against the validation is performed.
