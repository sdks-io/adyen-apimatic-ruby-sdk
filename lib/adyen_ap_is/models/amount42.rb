...
module AdyenApIs
  # For a billing plan where the payment amount is fixed, the amount the shopper
  # will be charged for each recurring payment.
  class Amount42 < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      Amount42.new(currency: currency,
                   value: value)
    end

    # Validates an instance of the object from a given value.
    # @param [Amount42 | Hash] The value against the validation is performed.
