...
module AdyenApIs
  # Authentication data produced by an MPI (Mastercard SecureCode, Visa Secure,
  # or Cartes Bancaires).
  class ThreeDSecureData1 < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      ThreeDSecureData1.new(authentication_response: authentication_response,
                            cavv: cavv,
    ...
    # @param [ThreeDSecureData1 | Hash] The value against the validation is performed.
