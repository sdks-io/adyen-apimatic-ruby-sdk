...
module AdyenApIs
  ...
  class PaymentLinkResponse < BaseModel
    ...
    def initialize(amount:, id:, merchant_account:, reference:, status:, url:,
    ...
    def self.from_hash(hash)
      ...
      PaymentLinkResponse.new(amount: amount,
                              id: id,
                              merchant_account: merchant_account,
                              reference: reference,
                              status: status,
    ...
    def to_s
      ...
      " #{@fund_recipient}, id: #{@id}, installment_options: #{@installment_options}, line_items:"\
      ...
      " #{@split_card_funding_sources}, splits: #{@splits}, status: #{@status}, store: #{@store},"\
      ...
      " #{@three_ds2_request_data}, updated_at: #{@updated_at}, url: #{@url}>"
    end
    ...
    def inspect
      ...
      " manual_capture: #{@manual_capture.inspect}, mcc: #{@mcc.inspect}, merchant_account:"\
      ...
      " #{@split_card_funding_sources.inspect}, splits: #{@splits.inspect}, status:"\
      " #{@status.inspect}, store: #{@store.inspect}, store_payment_method_mode:"\
      ...
      " #{@three_ds2_request_data.inspect}, updated_at: #{@updated_at.inspect}, url:"\
      " #{@url.inspect}>"
    end
  end
end
