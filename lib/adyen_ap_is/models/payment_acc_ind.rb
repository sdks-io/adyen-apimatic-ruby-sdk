...
module AdyenApIs
  ...
  # cardholder’s account with the 3DS Requestor.  Allowed values: * **01** — No
  # account (guest checkout) * **02** — During this transaction * **03** — Less
  # than 30 days * **04** — 30–60 days * **05** — More than 60 days
  class PaymentAccInd
    PAYMENT_ACC_IND = [
