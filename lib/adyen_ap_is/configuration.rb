...
module AdyenApIs
  ...
  class Configuration < CoreLibrary::HttpClientConfiguration
    ...
    attr_reader :environment, :api_key_auth_credentials, :basic_auth_credentials
    ...
    def initialize(
      ...
      api_key_auth_credentials: nil, basic_auth_credentials: nil
    )
    ...
    def clone_with(connection: nil, adapter: nil, timeout: nil,
                   ...
                   environment: nil, api_key_auth_credentials: nil,
      ...
      api_key_auth_credentials ||= self.api_key_auth_credentials
    ...
    ENVIRONMENTS = {
      Environment::PRODUCTION => {
        Server::DEFAULT => 'https://checkout-test.adyen.com/v71',
    ...
    def self.build_default_config_from_env
      ...
      api_key_auth_credentials = ApiKeyAuthCredentials.from_env
