...
module AdyenApIs
  ...
  class TerminalSettingsStoreLevelApi < BaseApi
    # Returns the logo that is configured for a specific payment terminal model
    # at the store identified in the path.
      ...
      @api_call
        .request(new_request_builder(HttpMethodEnum::GET,
                   ...
                   .template_param(new_parameter(merchant_id, key: 'merchantId')
                                    .is_required(true)
                                    .should_encode(true))
                   .template_param(new_parameter(reference, key: 'reference')
                                    .is_required(true)
                                    .should_encode(true))
    ...
    # at the store identified in the path. You can update the logo for only one
    # terminal model at a time.
    # This logo applies to all terminals of the specified model under the store,
    # unless a different logo is configured for an individual terminal.
    # * To change the logo, specify the image file as a Base64-encoded string.
    # * To restore the logo inherited from a higher level (merchant or company
    # account), specify an empty logo value.
    ...
    # Returns the payment terminal settings that are configured for the store
    # identified in the path. These settings apply to all terminals under the
    # store unless different values are configured for an individual terminal.
    # To make this request, your API credential must have one of the following
    # [roles](https://docs.adyen.com/development-resources/api-credentials#api-p
    # ermissions):
    # * Management API—Terminal settings read
    ...
    # Updates payment terminal settings for the store identified in the path.
    # These settings apply to all terminals under the store, unless different
    # values are configured for an individual terminal.
    ...
    # The logo is returned as a Base64-encoded string. You need to Base64-decode
    # the string to get the actual image file.
    # This logo applies to all terminals of that model under the store unless a
    # different logo is configured for an individual terminal.
    # To make this request, your API credential must have one of the following
    # [roles](https://docs.adyen.com/development-resources/api-credentials#api-p
    # ermissions):
    # * Management API—Terminal settings read
